...
ActiveRecord::Schema.define(version: 20141202090508) do
  ...
  add_index "admins", ["email"], name: "index_admins_on_email", unique: true, length: {"email"=>191}, using: :btree
  add_index "admins", ["reset_password_token"], name: "index_admins_on_reset_password_token", unique: true, length: {"reset_password_token"=>191}, using: :btree
